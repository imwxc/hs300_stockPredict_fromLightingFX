...
def get_train_data(train_dir,batch_size=args.batch_size, time_step=args.time_step):
    ratio = args.ratio
    stock_len = get_data_len(train_dir)
    len_index = []
    batch_index = []
    val_index = []
...
def get_test_data(test_dir,time_step=args.time_step):
    stock_len = get_data_len(test_dir)
...
def get_update_data(old_data_dir,new_data_dir,time_step=args.time_step):
    train_data_dir = old_data_dir
    new_data_dir = new_data_dir
    stock_len = get_data_len(old_data_dir)
    new_len = get_data_len(new_data_dir)
...
def get_predict_data(file_name):
    ...
    real_data = real_data[['open', 'high', 'price', 'low', 'vol']]
    ...
    real_data[['open', 'high', 'close', 'low', 'vol', 'change']] = \
        real_data[['open', 'high', 'close', 'low', 'vol', 'change']].astype('float')
